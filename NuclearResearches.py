...
def append_nuclear(xy, append_levels, researches):
	append_levels({
		...
		"Unlocks": [["Assembler", "ControlCell"], ["Hand", "ControlCell"],["FissionReactor", "ControlCell"]],
		"Chapter": "Production",
	...
	append_levels({
		...
		"Unlocks": [["Assembler", "ReflectorCell"], ["Hand", "ReflectorCell"],["FissionReactor", "UraniumCell2"]],
		"Chapter": "Production",
