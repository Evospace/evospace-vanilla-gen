...
cvs.append(
    [
        "KineticInput",
        '<img id="Kinetic"></>Consumes kinetic energy<img id="Kinetic2"></>',
    ]
)
cvs.append(
    [
        "KineticOutput",
        '<img id="Kinetic"></>Produces kinetic energy<img id="Kinetic2"></>',
    ]
)
cvs.append(
    [
        "KineticConductor",
        '<img id="Kinetic"></>Conducts kinetic energy<img id="Kinetic2"></>',
    ]
)
...
cvs.append(
    ["HeatConductor", '<img id="Heat"></>Conducts heat energy<img id="Heat2"></>']
)
...
cvs.append(
    [
        "ElectricInput",
        '<img id="Electricity"></>Consumes electricity<img id="Electricity2"></>',
    ]
)
cvs.append(
    [
        "ElectricOutput",
        '<img id="Electricity"></>Produces electricity<img id="Electricity2"></>',
    ]
)
cvs.append(
    [
        "ElectricConductor",
        '<img id="Electricity"></>Conducts electricity<img id="Electricity2"></>',
    ]
)
